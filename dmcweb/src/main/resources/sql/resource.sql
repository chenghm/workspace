...
INSERT INTO `t_resource` (`id`,`code`,`created_time`,`created_user`,`descn`,`name`,`parent_code`,`status`,`updated_time`,`updated_user`,`url`) VALUES (38,'device',NULL,NULL,NULL,'设备管理','index',1,NULL,NULL,'#');
INSERT INTO `t_resource` (`id`,`code`,`created_time`,`created_user`,`descn`,`name`,`parent_code`,`status`,`updated_time`,`updated_user`,`url`) VALUES (39,'sysconfig',NULL,NULL,NULL,'安装配置','device',1,NULL,NULL,'/installconfig.jsp');
INSERT INTO `t_resource` (`id`,`code`,`created_time`,`created_user`,`descn`,`name`,`parent_code`,`status`,`updated_time`,`updated_user`,`url`) VALUES (40,'syscontrol',NULL,NULL,NULL,'系统控制','device',1,NULL,NULL,'/syscontrol.jsp');
INSERT INTO `t_resource` (`id`,`code`,`created_time`,`created_user`,`descn`,`name`,`parent_code`,`status`,`updated_time`,`updated_user`,`url`) VALUES (41,'sysstatus',NULL,NULL,NULL,'系统状态','device',1,NULL,NULL,'/sysstatusaction');
