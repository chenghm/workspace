...
public class Criterion {
	 public static enum CriterionType {  
	    ...
	    public static List<Object> getCriteriaValues(Class<?> clazz,List<Criterion> criteria) throws Exception {  
	        ...
	        for (Criterion criterion : criteria) {  
	 	           ...
	 	           if(Integer.class.equals(type)){
		 	        	  value = Integer.valueOf(String.valueOf(value));
		 		    	   ...
		 		    	   value =  DateUtils.parseDate(String.valueOf(value), "yyyy-MM-dd HH:mm:ss","yyyy-MM-dd");
		 		       }    
