...
/**
 * The persistent class for the t_through_record database table.
 * 
 */
@Entity
@Table(name="t_through_record")
public class ThroughRecord implements Serializable {
