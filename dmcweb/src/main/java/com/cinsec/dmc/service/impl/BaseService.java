...
import com.cinsec.dmc.dao.IBaseDao;
...
public class BaseService<T extends Object> implements IBaseService<T>,
	...
	@Override
	public boolean isDuplicated(Resource resource, String propertyName,
	...
	@Override
	@Transactional
	public void writeOperLog(String msg) {
		LogOperation operator = new LogOperation();
		Date date = new Date();
		String username = UserContext.getCurrentUserName();
		operator.setLogTime(date);
		operator.setLogUser(username);
		operator.setLogContent(msg);
		operator.setLogIp(ContextFactory.getUserIp());
		this.create((T) operator);
	}
