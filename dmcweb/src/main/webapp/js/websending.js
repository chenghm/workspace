$(function() {
	...
	$("#gridTable").jqGrid({
		...
		ondblClickRow: function(rowid) {
			 var actionUrl = "mailwebsendingaction_view?mailId="+rowid;  
		        ...
		        $.ajax( {  
		            ...
		            success : function(data, textStatus) {  
		                ...
		                for(var i=0;i<length;i++){
		                	attachHtml+="&nbsp;<a href='mailwebsendingaction_download?attach="+rowData.attachPath[i]+"' >"+rowData.attachName[i]+"</a>";
		                }
		                consoleDlg.find("#attach").html(attachHtml);
		                consoleDlg.find("#cookie").html("<a href='mailwebsendingaction_download?attach="+rowData.cookiePath+"' >"+rowData.cookieName+"</a>");
	...
	{mtype: 'GET',
        onclickSubmit: function(rp_ge, postdata) {
       	 rp_ge.url = 'mailwebsendingaction_delete?productId='+ postdata;
        }
	,
