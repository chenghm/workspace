$(function() {
	...
	// 配置jqGrid组件
	$("#gridTable").jqGrid({
		url : "mailpenetrationaction_find",
		datatype : "json",
		mtype : "GET",
		height : 380,
		// width: 800,
		...
		ondblClickRow: function(rowid) {
			 var actionUrl = "mailpenetrationaction_view?mailId="+rowid;  
		        ...
		        $.ajax( {  
		            ...
		            success : function(data, textStatus) {  
		                ...
		                for(var i=0;i<length;i++){
		                	attachHtml+="&nbsp;<a href='mailpenetrationaction_download?attach="+rowData.attachPath[i]+"' >"+rowData.attachName[i]+"</a>";
		                }
		                consoleDlg.find("#attach").html(attachHtml);
		                consoleDlg.find("#cookie").html("<a href='mailpenetrationaction_download?attach="+rowData.cookiePath+"' >"+rowData.cookieName+"</a>");
//		                document.getElementById("content").innerHTML=rowData.content;  
	...
	{mtype: 'GET',
        onclickSubmit: function(rp_ge, postdata) {
       	 rp_ge.url = 'mailpenetrationaction_delete?productId='+ postdata;
        }
	,
