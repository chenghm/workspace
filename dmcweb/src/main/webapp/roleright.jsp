...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery-1.9.0.min.js" ></script>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/roleright.js" ></script>
    <title>角色分配权限</title>
	...
	<form  id="form_role_right">
		<div style="margin-left: 10px">
			<table  style="width: 98%">
				<tr>
					<td><input type="button" id="query_role_right" name="query"  value="查询权限" onclick="queryRoleRight()"/>&nbsp;&nbsp;
						<input type="button" id="save_role_right" name="save" value="保存授权"  onclick="saveRoleRight()"/>
					</td>
				</tr>
			</table>
		</div>
		...
		<div style="width:100%;margin-left: 10px;">
			<div style="display:inline-block;width:25%;height:400px;vertical-align: top;">
							...
							<select id="roleId" name="roleId" multiple="multiple" 
								...
								<c:forEach items="${roles}" var="role" >
										<option value="${role.id}" 
											<c:if test="${roleId==role.id}">selected</c:if> ondblclick="queryRoleRight()">${role.name}</option>
								</c:forEach>	
							</select>
						</td>
					</tr>
			...
			<div style="display:inline-block;width:35%;height:400px;">
				<table border="0"  width="100%" >
					...
					<tr>
						<td>
							<div style="border: solid 1px silver;width: 100%;height: 396px;overflow: auto;vertical-align: top;">
			...
			<div style="display:inline-block;width:35%;height:400px;">
				<table border="0" width="100%">
					...
					<tr>
						<td>
							<div style="border: solid 1px silver;width: 100%;height: 396px;overflow: auto;">
